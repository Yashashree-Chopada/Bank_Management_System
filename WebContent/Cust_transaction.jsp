...
System.out.println("Name is from Profile.jsp"+name);
List accList = proDao.getAccountDetails(name1,phno);
...
To check your Transaction History ::
    ...
    <input type="text" placeholder="Enter Account Number" name="acc" required = "required">
