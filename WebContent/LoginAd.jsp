...
%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="index.html" name = "back">Home</a>
      </li>
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="LoginAd.jsp" name="LA">Login for Admin</a>
      </li>
       </li>
       <li class="nav-item">
        <a name = "logincust" class="nav-link" href="Login_new.html">Login for customer</a>
      </li>
      <li class="nav-item">
        <a name = "click" class="nav-link" href="http://127.0.0.1:5000/">FAQ Bot</a>
      </li>
            ...
            <form action="AdminServlet" method ="post">
                ...
                <div class="card2 card border-0 px-4 py-5">
                     ...
                     <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input  type="text" placeholder="Enter mobile number" name="phn" required><br> </div>
                        <br>
                         <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Password</h6>
                        </label><input type="password" placeholder="Enter Password" name="psw" required></div>
                        <br><br>
              	<button type="submit" name="logAd">Login</button>
